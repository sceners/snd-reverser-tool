...
BLOWFISH_ENC_RT proc uses esi edx ecx  _Input:dword,_Output:dword,_len:dword
		...
		.IF (EAX < 4) || (EAX > 56)
			invoke SetDlgItemText, hWindow, IDC_INFO,addr sErrorLen464
	...
	EncryptLoop:
			...
			INVOKE BlowfishEncrypt,offset bf_encryptbuf,offset bf_tempbuf
...
BLOWFISH_DEC_RT proc uses esi edx ecx  _Input:dword,_Output:dword,_len:dword
		...
		.IF (EAX < 4) || (EAX > 56)
			...
			mov eax, FALSE
		.ELSE
		INVOKE BlowfishInit,addr sKeyIn,eax
		;	
		mov	bPassedRound,0
		mov eax, [_len]
		cmp eax, 2
	...
	DecryptLoop:
			...
			INVOKE BlowfishDecrypt,offset bf_encryptbuf,offset bf_tempbuf
			DecryptEnd 8
